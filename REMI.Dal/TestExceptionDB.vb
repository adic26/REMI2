...
#Region "Public Methods"
        ...
        '''' This is used to get the test exceptions for a test unit at a particular test stage.
        '''' </summary> 
        'Public Shared Function GetExceptionsTableForProductGroup(ByVal productID As Int32) As Dictionary(Of String, Boolean)
        '    Dim tempList As New Dictionary(Of String, Boolean)

        '    Using myConnection As New SqlConnection(REMIConfiguration.ConnectionStringREMI)
        '        Using myCommand As New SqlCommand("remispTestExceptionsGetProductGroupTable", myConnection)
        '            myCommand.CommandType = CommandType.StoredProcedure
        ...
        '''' <summary>
        '''' Returns a list of exceptions for the batch as standard objects. Does not return product level exceptions
        '''' </summary>
        '''' <returns></returns>
        '''' <remarks></remarks>
        'Public Shared Function GetExceptionsForBatchOnly(ByVal qraNumber As String, ByVal myConnection As SqlConnection) As TestExceptionCollection
        '    Dim tempList As New TestExceptionCollection

        '    Using myCommand As New SqlCommand("remispTestExceptionsGetBatchOnlyExceptions", myConnection)
        '        myCommand.CommandType = CommandType.StoredProcedure
        '        myCommand.Parameters.AddWithValue("@qranumber", qraNumber)
        '        If myConnection.State <> ConnectionState.Open Then
        '            myConnection.Open()
        ...
        '    Using myConnection As New SqlConnection(REMIConfiguration.ConnectionStringREMI)
        '        myConnection.Open()
        '        Return GetExceptionsForBatch(qraNumber, myConnection)
        '    End Using
        'End Function

        'Public Shared Function GetExceptionsForBatchOnly(ByVal qraNumber As String) As TestExceptionCollection
        '    Using myConnection As New SqlConnection(REMIConfiguration.ConnectionStringREMI)
        '        myConnection.Open()
        '        Return GetExceptionsForBatchOnly(qraNumber, myConnection)
        '    End Using
        'End Function

        'Public Shared Sub CopyExceptionsForTestStage(ByVal oldTestStageID As Integer, ByVal newTestStageID As Integer, ByVal username As String)
        '    Dim tempList As New TestExceptionCollection

        '    Using myConnection As New SqlConnection(REMIConfiguration.ConnectionStringREMI)
        '        Using myCommand As New SqlCommand("remispTestExceptionsCopyExceptions", myConnection)
        '            myCommand.CommandType = CommandType.StoredProcedure
        '            myCommand.Parameters.AddWithValue("@oldTestStageID", oldTestStageID)
        '            myCommand.Parameters.AddWithValue("@newTestStageID", newTestStageID)
        ...
        '''' <summary>
        '''' Returns a list of exceptions for the product as standard objects.
        '''' </summary>
        '''' <returns></returns>
        '''' <remarks></remarks>
        'Public Shared Function GetExceptionsForProduct(ByVal productID As Int32, ByVal startRowIndex As Integer, ByVal maximumRows As Integer) As TestExceptionCollection
        '    Dim tempList As New TestExceptionCollection

        '    Using myConnection As New SqlConnection(REMIConfiguration.ConnectionStringREMI)
        '        Using myCommand As New SqlCommand("remispTestExceptionsGetProductExceptions", myConnection)
        '            myCommand.CommandType = CommandType.StoredProcedure
        '            myCommand.Parameters.AddWithValue("@productID", productID)
        ...
        '                If myReader.HasRows Then
        '                    While myReader.Read()
        '                        tempList.Add(FillDataRecord(myReader, String.Empty))
        '                    End While
        '                End If
        '            End Using
        '        End Using
        ...
        'Public Shared Function GetProductExceptionCount(ByVal productID As Int32) As Integer
        ...
        '            Dim CountParam As DbParameter = myCommand.CreateParameter()
        '            CountParam.DbType = DbType.Int32
        '            CountParam.Direction = ParameterDirection.InputOutput
        '            CountParam.ParameterName = "@RecordCount"
        '            CountParam.Value = 0
        '            myCommand.Parameters.Add(CountParam)

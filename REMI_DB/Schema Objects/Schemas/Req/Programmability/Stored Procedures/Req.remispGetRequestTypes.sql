...
AS
BEGIN
	SELECT lt.[Values] AS RequestType, l.[Values] AS Department, rta.IsActive, rt.HasIntegration, rt.RequestTypeID, ISNULL(ud.IsAdmin, 0) AS IsAdmin, ud.UserDetailsID

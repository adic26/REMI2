...
<asp:Content ID="Content4" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:Panel Visible="true" runat="server" ID="pnlSearchBatch">
        ...
        <br />
        Department: <asp:DropDownList ID="ddlDepartment" runat="server" AppendDataBoundItems="true" AutoPostBack="false" Width="120px" ForeColor="#0033CC" DataTextField="LookupType" DataValueField="LookupID"></asp:DropDownList>
        <br /> 

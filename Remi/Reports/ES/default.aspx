...
<asp:Content ID="content" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:Panel runat="server" ID="pnlES" CssClass="CollapseHeader" style="cursor:none;">
            ...
            <tr>
                ...
                <td width="50%">
                    ...
                    <asp:DropDownList runat="server" ID="ddlStatus" Visible="true" AutoPostBack="true">
                        ...
                        <asp:ListItem Text="Un-Verified Pass" Value="4" />
                        <asp:ListItem Text="Un-Verified Fail" Value="5" />
                    </asp:DropDownList>
                </td>
            </tr>
        </table><br />
        ...
        <br />
        <asp:GridView runat="server" ID="grdJIRAS" ShowFooter="false" AutoGenerateColumns="false" AutoGenerateDeleteButton="false" CssClass="ESGridView">
    ...
    <asp:Panel runat="server" ID="pnlRequestInfo" CssClass="CollapseBody">
        <asp:GridView ID="gvwRequestInfo" runat="server" AutoGenerateColumns="false" ShowHeader="false" Width="600" CssClass="ESGridView">
            <RowStyle CssClass="evenrow" />
            <Columns>
    ...
    <asp:UpdatePanel ID="updResultBreakdown" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="false" EnableViewState="true">
        ...
        <ContentTemplate>
            ...
            <asp:Panel runat="server" ID="pnlObservationSummaryInfo" CssClass="CollapseBody">
                ...
                <asp:GridView ID="gvwObservationSummary" runat="server" DataSourceID="odsObservations" OnDataBound="gvwObservationSummary_DataBound" EnableViewState="true" AutoGenerateColumns="true" ShowHeader="true" CssClass="ESGridView">
                    <RowStyle CssClass="evenrow" />
                    <Columns>
            ...
            <asp:Panel runat="server" ID="pnlObservationsInfo" CssClass="CollapseBody">
                <asp:GridView ID="gvwObservations" runat="server" EnableViewState="true" OnDataBound="gvwObservations_DataBound" DataSourceID="odsObservationInfo" AutoGenerateColumns="false" ShowHeader="true" CssClass="ESGridView">
                    <RowStyle CssClass="evenrow" />
                    <Columns>
                        <asp:TemplateField HeaderText="Unit">
                            <ItemTemplate>
                                <asp:Label runat="server" Visible="true" ID="lblUnit" Text='<%# Eval("Unit")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Stage">
                            <ItemTemplate>
                                <asp:Label runat="server" Visible="true" ID="lblTestStage" Text='<%# Eval("Stage")%>' />
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <asp:TemplateField HeaderText="Attachment">
                            <ItemTemplate>
                                ...
                                <input type="image" src="../../Design/Icons/png/24x24/download.png" class="img-responsive" runat="server" visible="false" id='viewImages' mID='<%# Eval("MeasurementID") %>' pageID='<%# Me.ClientID %>' role="button" />
                            </ItemTemplate>
                        </asp:TemplateField>           
                    </Columns>
                    <AlternatingRowStyle CssClass="oddrow" />
            ...
            <asp:Panel runat="server" ID="pnlResultSummary" CssClass="CollapseBody">
                <asp:GridView ID="gvwResultSummary" DataSourceID="odsResultSummary" runat="server" AutoGenerateColumns="true" ShowHeader="true" CssClass="ESGridView">
                    <RowStyle CssClass="evenrow" />
                    <AlternatingRowStyle CssClass="oddrow" />
                </asp:GridView>
            ...
            <asp:Panel runat="server" ID="pnlResultBreakDown" CssClass="CollapseBody" EnableViewState="true">
                ...
                <asp:GridView ID="gvwResultBreakDown" runat="server" DataSourceID="odsResultBreakdown" EnableViewState="true" AutoGenerateColumns="false" DataKeyNames="ID" ShowHeader="true" CssClass="ESGridView">
                    <RowStyle CssClass="evenrow" />
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
    ...
    <asp:Panel runat="server" ID="pnlApproval" CssClass="CollapseBody">
        <asp:GridView runat="server" ID="grdApproval" AutoGenerateColumns="true" EmptyDataText="No Approvals" CssClass="ESGridView">
            <RowStyle CssClass="evenrow" />
            <AlternatingRowStyle CssClass="oddrow" />
        </asp:GridView>
    </asp:Panel>

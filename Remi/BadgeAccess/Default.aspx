...
<asp:Content ID="Content2" ContentPlaceHolderID="pageTitleContent" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            $("[id*=txtUserName], [id*=txtPassword], [id*=txtBadge], [id*=txtNewUserName], [id*=txtNewBadge], [id*=txtNewPassword]").WaterMark();
    ...
    <div style="text-align:center;">
        <asp:MultiView runat="server" ID="mvLogin" ActiveViewIndex="0">
            <asp:View runat="server" ID="vLogin">
                <asp:Table runat="server" ID="tblLogin" BorderStyle="None" HorizontalAlign="Center">
                    <asp:TableRow>
            ...
            <asp:View runat="server" ID="vCreate">
                <asp:Table runat="server" ID="tblCreate" BorderStyle="None" HorizontalAlign="Center">
                    <asp:TableRow>
                        <asp:TableCell CssClass="loginCell">
                            <asp:Label runat="server" ID="lblNewUser" Text="You Are A New User Please Create Your Account" CssClass="loginReturnTxt"></asp:Label><br />

...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="Server">
    ...
    <asp:DropDownList runat="server" ID="ddlSearchField" style="display:none;" DataTextField="Name" DataValueField="ReqFieldSetupID" AppendDataBoundItems="false" EnableViewState="true"></asp:DropDownList>
    <asp:TextBox runat="server" ID="txtSearchTerm" style="display:none;"></asp:TextBox>
    <asp:Button runat="server" ID="btnSave" Text="Add" style="display:none;" OnClick="btnSave_Click" />
    <br />
    <asp:ListBox runat="server"  ID="lstSearchTerms" style="display:none;"></asp:ListBox>

    <br />
    <asp:Button runat="server" ID="btnSearch" style="display:none;" Text="Search" OnClick="btnSearch_Click" />

    <asp:GridView runat="server" ID="grdRequestSearch"  style="display:none;" AutoGenerateColumns="true"></asp:GridView>

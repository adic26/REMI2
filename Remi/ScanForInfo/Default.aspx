    ...
    <asp:Panel ID="pnlSummary" runat="server">
        ...
        <asp:Accordion ID="accMain" runat="server" CssClass="Accordion" HeaderCssClass="AccordionHeader"
            ...
            <Panes>
                ...
                <asp:AccordionPane ID="acpJiras" runat="server">
                    <Header>
                        <h2>JIRA's</h2>
                    </Header>
                    <Content>
                        <asp:GridView runat="server" ID="grdJIRAS" ShowFooter="false" AutoGenerateColumns="false" AutoGenerateDeleteButton="false" DataKeyNames="JIRAID, BatchID" AutoGenerateEditButton="true" OnRowEditing="grdJIRAS_OnRowEditing" OnRowCancelingEdit="grdJIRAS_OnRowCancelingEdit" OnRowUpdating="grdJIRAS_RowUpdating" EmptyDataText="No JIRA's Added">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="Display Name" SortExpression="">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblDisplayName" Text='<%# Eval("DisplayName")%>' Visible="true" />
                                        <asp:TextBox runat="server" ID="txtDisplayName" Text='<%# Eval("DisplayName")%>' Visible="false"></asp:TextBox>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Link" SortExpression="">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblLink" Text='<%# Eval("Link")%>' Visible="true" />
                                ...
                                <asp:TemplateField HeaderText="Title" SortExpression="">
                                    <ItemTemplate>
                                        <asp:Label runat="server" ID="lblTitle" Text='<%# Eval("Title")%>' Visible="true" />
                                        <asp:TextBox runat="server" ID="txtTitle" Text='<%# Eval("Title")%>' Visible="false"></asp:TextBox>
                                    </ItemTemplate>
                                    <FooterStyle HorizontalAlign="Right" />
                                    <FooterTemplate>

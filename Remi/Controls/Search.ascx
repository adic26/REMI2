<%@ Control Language="vb" AutoEventWireup="false" CodeBehind="Search.ascx.vb" Inherits="Remi.Search1" %>
    ...
    <link href="../Design/jQueryCSS/DataTableCSS/dataTables.colVis.css" rel="stylesheet"/>
    <link href="../Design/jQueryCSS/DataTableCSS/dataTables.colvis.jqueryui.css" rel="stylesheet" />
    ...
    <script type="text/javascript" src="../Design/scripts/DataTables/dataTables.colVis.js"></script>
    <!--include BlockUI -->
        ...
        <div class="col-lg-6">
            <div class="input-group input-group-sm">
                <div class="input-group-btn">
                    ...
                    <select id="bs_Additional" class="selectpicker show-tick" title="Select Additional..." multiple data-size="15" data-selected-text-format="count"></select>              
